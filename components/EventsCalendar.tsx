...
function cleanEventId(id: string) {
  return stegaClean(id || '');
}
            ...
            {events.map((e) => {
              ...
              return (
                <div
                  ...
                  className="card relative border border-emerald-50 transition hover:-translate-y-[1px] hover:shadow-md"
                >
                  {/* accent bar */}
                  ...
                  <div className="pl-3">
                    ...
                    <EventCommentForm eventId={cleanEventId(e._id)} />
                  </div>
                </div>
              );
            })}
